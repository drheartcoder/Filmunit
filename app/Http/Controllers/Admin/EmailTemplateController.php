...
{   
	public function __construct(EmailTemplateModel $email_template, LanguageService $langauge,EmailTemplateTranslationModel $email_template_translation
        )
    {
        ...
        $this->site_email_address = isset($arr_site_settings['info_email_address']) && $arr_site_settings['info_email_address'] != "" ? $arr_site_settings['info_email_address'] : 'info@filmunit.com';
    }
