           ...
           {{ csrf_field() }}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="first_name" value="{{ old('first_name') }}" data-rule-required="true" data-rule-maxlength="255" data-rule-lettersonly ='true' placeholder="First Name" />
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="last_name" value="{{ old('last_name') }}" data-rule-required="true" data-rule-maxlength="255"  placeholder="Last Name"  data-rule-lettersonly ='true' />
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="email" value="{{ old('email') }}" data-rule-required="true" data-rule-email="true" data-rule-maxlength="255" placeholder="Email" />
                             ...
                             @foreach($arr_modules as $key => $row )
                              <tr class="info">
                                  <td><b>{{$row['title']}}</b></td>                                                                   
                                        ...
                                        <td> <input class="form-control"   type="checkbox" data-module-ref="{{$slug}}" data-module-action-ref="List" name="arr_permisssion[subadmin][{{$slug}}.list]"   value="true" > 
                                        </td>
                                                                                                      
                                        
                                        <td> <input class="form-control" type="checkbox" data-module-ref="{{$slug}}" data-module-action-ref="Create" name="arr_permisssion[subadmin][{{$slug}}.create]"  value="true" > 
                                        </td>
                                                                                                      
                                        
                                        <td> <input class="form-control" {{$checkbox_checked}} {{ $required_checked }} type="checkbox" data-module-ref="{{$slug}}" data-module-action-ref="Update" name="arr_permisssion[subadmin][{{$slug}}.update]" value="true" "> 
                                        </td>                                               
                                                       
                                        
                                        <td> <input class="form-control"  type="checkbox" data-module-ref="{{$slug}}" data-module-action-ref="Delete" name="arr_permisssion[subadmin][{{$slug}}.delete]" value="true" > 
                                        </td>
