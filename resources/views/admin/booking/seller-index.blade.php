    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">       
          ...
          <input type="hidden" id="seller_id" name="seller_id" value="{{Request::segment(4)}}">
          @include('admin.layout._operation_status')  
          
            <div class="row pull-left" >
              <form name="frmexport" id="frmexport" action="{{ $module_url_path }}/export_seller" method="GET">   
                 {{ csrf_field() }}
                  <div class="col-md-3">
                  ...
                  <thead>
                    <tr>                          
                        ...
                        <th><a class="sort-desc sort-asc" href="#">Order Amount ($)</a>
                            <input type="text" name="q_price_total" placeholder="Search" class="search-block-new-table column_filter" />
                        </th> 
                        
                        <th><a class="sort-desc" href="#">Invoice Total ($)</a></th>
                      <th>Status</th>
...
<script type="text/javascript">
  ...
  $(document).ready(function()
  {
    table_module = $('#table_module').DataTable({ 
      ...
      bFilter: false ,
      ajax: {
      'url':'{{ $module_url_path.'/seller/get_records?sellerid='}}{{$sellerid or ''}}',
       'data': function(d)
        {
          ...
          d['column_filter[q_price_total]']             = $("input[name='q_price_total']").val()
        }
      },
      columns: [
      ...
      {data: 'price_total', "orderable": true, "searchable":false},      
      {
        render : function(data, type, row, meta) 
        {
          return row.invoice_ammount;
        },
