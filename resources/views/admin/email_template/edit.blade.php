                  ...
                  @if(isset($arr_lang) && sizeof($arr_lang)>0)
                        @foreach($arr_lang as $lang)
                              ...
                              @if($lang['locale'] == 'en')  
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-6 col-lg-4 controls">   
                                    ...
                                    <input type="text" name="template_name" required=""  placeholder="Email Template Name" value="{{$template_name or ''}}"  class="form-control add-stundt"/>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-6 col-lg-4 controls">       
                                    {!! Form::text('template_from',$arr_data['template_from'],['class'=>'form-control','required'=>'true','data-rule-maxlength'=>'255', 'placeholder'=>'Email Template From']) !!}  
                                  </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-6 col-lg-4 controls">       
                                    {!! Form::text('template_from_mail',$arr_data['template_from_mail'],['class'=>'form-control','required'=>'true','data-rule-maxlength'=>'255', 'placeholder'=>'Email Template From Email']) !!}  
                                  </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6 col-lg-4 controls">
                              @if($lang['locale'] == 'en')       
                                <input type="text" name="template_subject_{{$lang['locale']}}" required=""  placeholder="Email Template Subject" value="{{$template_subject}}"  class="form-control add-stundt"/>
                              @else
                                <input type="text" name="template_subject_{{$lang['locale']}}" placeholder="Email Template Subject" value="{{$template_subject}}"  class="form-control add-stundt"/>
                              @endif
                              </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-6 col-lg-8 controls">   
                                @if($lang['locale'] == 'en')  
                                  ...
                                  placeholder="Email Template Body">{{$template_html}}</textarea>
                                @else
                                  <textarea name="template_html_{{$lang['locale']}}" class="form-control"  rows="10"  placeholder="Email Template Body">{{$template_html}}</textarea>
                                @endif
                              </div>
