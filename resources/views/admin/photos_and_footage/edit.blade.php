    ...
    <div class="row">
      ...
      <div class="tabbable">
                ...
                {!! Form::open([ 'url' => $admin_panel_slug.'/photos_and_footage/update/'.base64_encode($arr_data['id']),
                                 'method'=>'POST',
                  ...
                  <!--   {{dump($arr_data)}} -->
                      @if($arr_data['is_approved']==1)
                        ...
                        <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label" for="state">Seller Name <i class="red">*</i></label>
                              <div class="col-sm-6 col-lg-4 controls">
                                    <input type="text" class="form-control" type="text" placeholder="Enter Seller Name" name='name' id='name' maxlength="255" value="{{ ($arr_data['seller_details']['first_name']) }} {{($arr_data['seller_details']['last_name']) }}" readonly="">
                                    <div class="help-block" id="err_type">{{$errors->first('name')}}</div>
                              </div>
                        </div>

                         <div class="form-group">
                              <label class="col-sm-3 col-lg-2 control-label" for="state">Seller Email <i class="red">*</i></label>
                              <div class="col-sm-6 col-lg-4 controls">
                                    <input type="text" class="form-control" type="text" placeholder="Enter Seller Email" name='email' id='email' maxlength="255" value="{{ ($arr_data['seller_details']['email']) }}" readonly="">
                                    <div class="help-block" id="err_type">{{$errors->first('email')}}</div>
                              </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 col-lg-4 controls">
                                  <input type="text" class="form-control" name="keywords" id="keywords"  value="{{ ucfirst($arr_data['keywords']) }}" maxlength="255" placeholder="Enter Search Keywords">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                               <div class="fileupload fileupload-new parent-image" data-provides="fileupload">
                                  <div class="fileupload-new img-thumbnail option_footage_preview" style="width: 200px; height: 150px;">
