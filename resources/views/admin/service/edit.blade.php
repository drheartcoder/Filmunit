      ...
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <div class="tabbable">
                ...
                {!! Form::open([ 'url' => $admin_panel_slug.'/service/update/'.$enc_id,
                                 'method'=>'POST',
                    ...
                    {{-- @if($lang['locale']=="en") --}}    
                        <div class="form-group">
                              ...
                              <div class="col-sm-6 col-lg-4 controls">
                               <select name="category" id="category" data-rule-required="true" class="form-control">
                                 ...
                                 @if($arr_service_data['category_details']['id'] == $category['id'])
                                 <option value="{{$arr_service_data['category_details']['id']}}" selected>{{$arr_service_data['category_details']['title']}}</option>
                                 @else
                      ...
                      {{-- @endif --}}
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                          <input type="text" class="form-control" name="title"  data-rule-required='true' value="{{$arr_service_data['title']}}" maxlength="255" placeholder="Enter Title">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-lg-4 controls">
                                          <input type="text" class="form-control" name="price" data-rule-required='true' value="{{$arr_service_data['price']}}" data-rule-number='true' placeholder="Enter Price" min="1">
                                            {{-- {!! Form::text('title',old('title'),['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255' , 'placeholder'=>'Enter Title']) !!} --}}  
                              ...
                              <div class="form-group">
                                      ...
                                      <div class="col-sm-6 col-lg-4 controls">
                                         ...
                                         <textarea class='form-control' name="description" placeholder='Description' name='Enter description' value="{{old('description')}}" data-rule-required='true' maxlength="1000">{{$arr_service_data['description']}}</textarea>     
                                      </div>
                            ...
                            <div class="col-sm-9 col-lg-10 controls">
                               <div class="fileupload fileupload-new" data-provides="fileupload">
                                  <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                                   <img src="{{$service_public_img_path.$arr_service_data['image']}}">   
                                  </div>
...
function subcategory_details(action)
{
  ...
  var category_id = $("#category").val();
        ...
        $.ajax({
            ...
            success:function(response){
              ...
              {
                var subcat = '<option value="">No subcategory present</option>';        
                $('#subcategory').append(subcat);
              }
            }
        });
