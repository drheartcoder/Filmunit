              ...
              <div id="myTabContent1" class="tab-content">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @else
                        {!! Form::text('page_title_'.$lang['locale'],$locale_page_title,['class'=>'form-control','placeholder'=>'Page Title','data-rule-maxlength'=>'255']) !!}
                    @endif    
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @else
                        {!! Form::text('meta_keyword_'.$lang['locale'],$locale_meta_keyword,['class'=>'form-control','placeholder'=>'Meta Keyword','data-rule-maxlength'=>'255']) !!}
                    @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-4 controls">
                    ...
                    @else
                        {!! Form::text('meta_desc_'.$lang['locale'],$locale_meta_desc,['class'=>'form-control','placeholder'=>'Meta Description','data-rule-maxlength'=>'255']) !!}
                    @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6 col-lg-8 controls">
                    ...
                    @if($lang['locale'] == 'en')        
                        {!! Form::textarea('page_desc_'.$lang['locale'],$locale_page_desc,['class'=>'form-control','data-rule-required'=>'true','placeholder'=>'Page Content']) !!}
                    @else
