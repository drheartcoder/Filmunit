                ...
                <div class="col-sm-8 col-md-8 col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="light-grey-bg-block padding-small new-block-css">
                                <h1 class="accou-heat"> Downloads </h1>
                                <div class="account-text-blocl">
                                    <h1> {{$download_count}} </h1>
                                    <h3>(Till the Date)</h3>
                                    <div class="clr"></div>
                                </div>
                                <div class="circle-icon-block">
                                    <a href="{{url('/')}}/buyer/downloads" class="circle-icon"> <i class="fa fa-cloud-download"></i> </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="light-grey-bg-block padding-small new-block-css">
                                <h1 class="accou-heat"> My collection </h1>
                                <div class="account-text-blocl">
                                    <h1> {{$favourite_count}} </h1>
                                    <h3>(Till the Date)</h3>
                                    <div class="clr"></div>
                                </div>
                                <div class="circle-icon-block">
                                    <a href="{{url('/')}}/my_collection" class="circle-icon line-height"> <i class="fa fa-heart"></i> </a>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
