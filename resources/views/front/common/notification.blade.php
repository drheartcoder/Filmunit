...
<!--                                <button type="button" class="close-noti" >-->
                                    <a class="close-noti" href="{{$module_url_path}}/delete/{{base64_encode($value['id'])}}" onclick="return confirm_action(this,event,'Do you really want to delete this record ?')">
