...
<div class="clearfix"></div>    
  ...
  <script type="text/javascript">
   ...
   <script type="text/javascript" src="{{url('/')}}/js/admin/bootstrap.min.js"></script>
   <script type="text/javascript" src="{{url('/')}}/js/admin/common.js"></script>
   <a class="cd-top hidden-xs hidden-sm" href="#0">Top</a>
   <script type="text/javascript" src="{{url('/')}}/js/admin/backtotop.js"></script>
  <script type="text/javascript"  src="{{url('/')}}/js/front/jquery.ui.touch-punch.min.js"></script>
  <script type="text/javascript"  src="{{url('/')}}/js/front/jquery.creditCardValidator.js"></script>   
</body>
</html>