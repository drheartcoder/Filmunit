...
<head>
    ...
    <?php 
        //echo file_get_contents('http://webwingdemo.com/node2/filmunit/wptheme/headerpage/');
    ?>

    <?php
	//code added by mapweb
	//require(dirname(dirname(dirname(dirname(__FILE__)))) . '/wptheme/wp-blog-header.php');	
	//wp_head();
	?>
</head>
