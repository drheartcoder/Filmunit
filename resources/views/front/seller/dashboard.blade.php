                ...
                <div class="col-sm-8 col-md-8 col-lg-9">
                    <div class="row dashboard-content">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="light-grey-bg-block padding-small  new-block-css">
                                <h1 class="accou-heat download-head-block"> My Photos & Footage </h1>
                                <div class="account-text-blocl">
                                    <h1 class="downlo-txt-blo-h1"> {{$media_count}} </h1>
                                    <h3>(Till the Date)</h3>
                                    <div class="clr"></div>
                                </div>
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="light-grey-bg-block padding-small  new-block-css">
                                ...
                                <div class="account-text-blocl">
                                    <h1 class="downlo-txt-blo-h1"> {{$transaction_count}} </h1>
                                    <h3>(Till the Date)</h3>
                                    <div class="clr"></div>
                                </div>
                                <div class="circle-icon-block hieght-no">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                            <div class="light-grey-bg-block padding-small  new-block-css">
                                <h1 class="accou-heat download-head-block"> Admin Photos & Footage </h1>
                                <div class="account-text-blocl">
                                    <h1 class="downlo-txt-blo-h1"> {{$admin_media_count}} </h1>
                                    <h3>(Till the Date)</h3>
                                    <div class="clr"></div>
                                </div>
                                <div class="circle-icon-block">
