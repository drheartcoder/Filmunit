...
function cnss_init_script() {
	...
	//wp_enqueue_script( 'cnss_js' );
	 ...
	 wp_enqueue_script('cnss_js', plugins_url('js/cnss.js', __FILE__), array('jquery'));	

	//wp_register_style( 'cnss_font_awesome_css', $cnssPluginsURI . 'css/font-awesome/css/font-awesome.min.css', false, '4.8' );
	//wp_enqueue_style( 'cnss_font_awesome_css' );
	wp_enqueue_style('cnss_font_awesome_css', plugins_url('css/font-awesome/css/font-awesome.min.css', __FILE__));
	
	//wp_register_style('cnss_css', $cnssPluginsURI . 'css/cnss.css', array(), '1.0' );
	//wp_enqueue_style( 'cnss_css' );	
	wp_enqueue_style('cnss_css', plugins_url('css/cnss.css', __FILE__));
