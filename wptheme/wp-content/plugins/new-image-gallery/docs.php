...
<div id="welcome-panel" class="welcome-panel">
	...
	<div class="welcome-panel-content">
		...
		<p class="">
			<h1><strong>Early Bird Offer:</strong> Upgrade To Premium Just In Half Prise <strike>$15</strike> <strong>$7</strong></h1>
			<br>
			...
			<a href="http://demo.awplife.com/image-gallery-premium-admin-demo/" target="_blank" class="button button-primary button-hero load-customize hide-if-no-customize">Try Premium Version</a>
		</p>
	</div>
</div>
</div>